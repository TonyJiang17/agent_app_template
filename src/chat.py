...
async def show_chat(prompt_placeholder: str = "Ask me anything!", extra_info: str = "", no_message_placeholder: str = "Hello! I'm an AI-powered research assistant with web search and a calculator. Ask me anything!"):
    model = None
    use_streaming = True
    ...
    if len(messages) == 0:
        with st.chat_message("ai"):
            st.write(no_message_placeholder)
